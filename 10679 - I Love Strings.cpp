...
void compute_LPS_array (char pat[], int lps[])
{
    int i, j, length;
    j=0;
    lps[0]=0;
...
void kmp_search (char text[], char pat[], int lps[])
{
    bool flag=true;
    int pat_index, text_index, length_text, length_pat;
    length_text=strlen (text);
    length_pat=strlen (pat);
    pat_index = 0;
    text_index = 0;
